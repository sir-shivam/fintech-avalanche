              ...
              <Card className="border-white/10 bg-black/20 backdrop-blur-xl overflow-hidden">
                  ...
                  >
                    ...
                    >
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                            Why is this UPI ID flagged as fraudulent?
                          </AlertDialogTitle>
                          <AlertDialogDescription>
                            `This UPI ID has been associated with multiple
                            reported scams and fraudulent activitiess strongly
                            recommended not to proceed with any transactions
                            using this ID.``
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                ...
                <CardFooter className="flex flex-col items-center justify-center bg-black/20 p-0 border-t border-white/10">
                  <Button
                    ...
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white py-6 transition-all duration-300"
                  >
                    Send Money
                  </Button>
                </CardFooter>
